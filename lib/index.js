...
function Replay (replayKey, distinctId, options) {
  if (!replayKey || typeof replayKey !== 'string') {
    throw 'Must provide a valid replayKey'
  }
  if (!distinctId || typeof distinctId !== 'string') {
    throw 'Must provide a valid clientId'
  }
...
Replay.prototype.send = function() {
  ...
  request(options, function(error, response, body){
    ...
    console.log('Send to',options.uri+':', JSON.stringify(options.json));
  });
